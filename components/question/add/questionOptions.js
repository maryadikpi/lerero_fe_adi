...
export default function questionOptions(props) {
    ...
    const handleChangeAnsDes = (e) => {
        ...
        setOptParams(e.target.value, isCorrect, feedback)
    }
    ...
    const handleCheckBox = () => {
        ...
        setOptParams(ansDesc, temp, feedback)
    }

    const handleChangeFeedback = (e) => {
        setFeedback(e.target.value)
        setOptParams(ansDesc, isCorrect, e.target.value )
    }

    const handleNumberInput = (e) => {
        setNumberText(e.target.value)
        setOptParams(null, e.target.value, null )
    }

    function setOptParams(ans, corr, feed) {
